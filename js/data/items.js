export const WEAPON_STATS = {
  ...
  export const SHOP_ITEMS = [
    ...
    { key: 'weaponWrench', label_ru: '🔧 Гаечный ключ', label_en: '🔧 Wrench', price: 40, type: 'weapon', weaponId: 'wrench' },
    { key: 'weaponPistol', label_ru: '🔫 10мм Пистолет', label_en: '🔫 10mm Pistol', price: 70, type: 'weapon', weaponId: 'pistol' },

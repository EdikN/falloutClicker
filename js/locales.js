export const TRANSLATIONS = {
    ru: {
        ...
        health: 'ЗДОРОВЬЕ', mood: 'РАССУДОК', hunger: 'ГОЛОД', thirst: 'ЖАЖДА', food: 'ЕДА', water: 'ВОДА',
        ...
        toast_water: '+45 ЖАЖДА, +5 РАССУДОК',
        toast_starving: 'КРИТИЧЕСКИЙ ГОЛОД!',
        toast_dehydrated: 'ОБЕЗВОЖИВАНИЕ!',
        toast_full: 'ВЫ НЕ ГОЛОДНЫ',
        toast_not_thirsty: 'ВЫ НЕ ХОТИТЕ ПИТЬ',
    ...
    en: {
        ...
        toast_water: '+45 THIRST, +5 SANITY',
        toast_starving: 'CRITICAL HUNGER!',
        toast_dehydrated: 'DEHYDRATION!',
        toast_full: 'YOU ARE FULL',
        toast_not_thirsty: 'YOU ARE NOT THIRSTY',

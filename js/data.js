export const GameData = (() => {
  ...
  const ENEMIES = [
    ...
    { name_ru: 'Токсичный упырь', name_en: 'Toxic Ghoul', hp: 60, dmg: 15, atk: 4.5, img: 'img/enemy_toxic_ghoul.webp', icon: '' },
    ...
    { name_ru: 'Ловчий Искина', name_en: 'AI Stalker', hp: 50, dmg: 18, atk: 3.5, img: 'img/enemy_hunter.webp', icon: '' },
    { name_ru: 'Слизь мусоропровода', name_en: 'Disposal Slime', hp: 110, dmg: 6, atk: 4.8, img: 'img/enemy_slime.webp', icon: '' }
  ];

  const ELITE_ENEMIES = [
    { name_ru: 'Ликвидатор', name_en: 'Liquidator', hp: 130, dmg: 18, atk: 3.8, armor: 0.2, img: 'img/enemy_liquidator.webp', icon: '' },
    { name_ru: 'Тяжелый МЕХ', name_en: 'Heavy MECH', hp: 180, dmg: 22, atk: 5.0, armor: 0.4, img: 'img/enemy_mech.webp', icon: '' },
    { name_ru: 'Прототип Ареса', name_en: 'Ares Prototype', hp: 250, dmg: 25, atk: 4.5, armor: 0.3, img: 'img/enemy_ares.webp', icon: '' },
  ...
  const STORY_ENEMIES = {
    amazon_weak: { name_ru: 'Амазонка-Синт (Ослаблена)', name_en: 'Amazon Synth (Weakened)', hp: 100, dmg: 12, atk: 3.5, armor: 0.1, img: 'img/enemy_amazon.webp', icon: '' },
    amazon_full: { name_ru: 'Амазонка-Синт', name_en: 'Amazon Synth (Full)', hp: 250, dmg: 32, atk: 2.5, armor: 0.2, img: 'img/enemy_amazon.webp', icon: '' },
    ...
    drifter_enemy: { name_ru: 'Синтетик-страж (x3)', name_en: 'Synth Guardian (x3)', hp: 120, dmg: 14, atk: 3.0, armor: 0.1, img: 'img/portrait_drifter.webp', icon: '' }
  };

window.GameState = (() => {
  ...
  const fresh = () => ({
    ...
    player: { maxHp: 100, hp: 100, maxMood: 100, mood: 80, maxStab: 100, stability: 100, impulse: 0, baseDmg: 8, dmgBonus: 2, weaponName: 'Ржавый пистолет' },
